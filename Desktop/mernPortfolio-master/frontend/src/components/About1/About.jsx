...
import "./About.css";
function About({ about, timelines = [] }) {
  useEffect(() => {
  ...
  return (
    <div className="container10">
      <div className="card1" data-state="#about">
        <div className="card1-header">
          <div className="card1-cover"></div>
          <img className="card1-avatar" src={about.avatar.url} alt="avatar" />
          <h1 className="card1-fullname">{about.name}</h1>
          <h2 className="card1-jobtitle">{about.title}</h2>
        </div>
        <div className="card1-main">
          <div className="card1-section is-active" id="about">
            <div className="card1-content">
              <div className="card1-subtitle">ABOUT</div>
              <p className="card1-desc">{about.subtitle}</p>
            </div>
            <div className="card1-social">
              <a href="#">
          ...
          <div className="card1-section" id="experience">
            <div className="card1-content">
              <div className="card1-subtitle">WORK EXPERIENCE</div>
              <div className="card1-timeline">
                {timelines.map((item, index) => (
                  <div
                    className="card1-item"
                    data-year={item.date.toString().split("T")[0]}
                    key={index}
                  >
                    <div className="card1-item-title">{item.title}</div>
                    <div className="card1-item-desc">{item.description}</div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="card1-section" id="contact">
            <div className="card1-content">
              <div className="card1-subtitle">CONTACT</div>
              <div className="card1-contact-wrapper">
